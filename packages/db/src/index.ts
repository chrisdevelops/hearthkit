...
export { createDrizzleClient } from './create-drizzle-client.js'

/** Creates a project database plus its same-named scoped login role. */
export { createProjectDatabase } from './create-project-database.js'

/** Drops a project database with force and drops its role. */
export { dropProjectDatabase } from './drop-project-database.js'

/** Writes a pg_dump custom-format archive of a project database. */
export { backupProjectDatabase } from './backup-project-database.js'

/** Restores a pg_dump custom-format archive into an existing project database. */
export { restoreProjectDatabase } from './restore-project-database.js'

/** Applies drizzle-kit generated migrations over the project-scoped connection. */
export { runDatabaseMigrations } from './run-database-migrations.js'
...
export type { DbFailure, PostgresConnectionString, ProjectDatabaseName } from './db-contract.js'
