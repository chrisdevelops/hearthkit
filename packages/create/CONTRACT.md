...
- **Any infrastructure provider.** `infra/tofu.tfvars` carries the project name only; `hearthkit infra apply`, `zone_name`, `host_ip` and the provider choice are Phase 7.
