...
- 4a0da18: Add `hearthkit infra apply` and the Cloudflare OpenTofu provider module (completion plan step 6.1).
...
- Updated dependencies [4a0da18]
  - @hearthkit/cli@0.5.0
  - @hearthkit/config@0.5.0
  - @hearthkit/db@0.5.0
  - @hearthkit/observability@0.5.0
  - @hearthkit/ui@0.5.0
