...
- Next: step 6.2 (VPS bootstrap and backups), branch `infra/vps-bootstrap`; its brief is
  `docs/next-session-vps.md`, which that PR deletes. Step 6.1 results: cli 42 → 47
